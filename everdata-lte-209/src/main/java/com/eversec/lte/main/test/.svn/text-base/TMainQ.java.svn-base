...
//
//public class TMainQ implements KafkaConsumerHandler {
//
//	private static Logger LOGGER = LoggerFactory.getLogger(TMainQ.class);
//	
//
...
//					.getKafkaConsumerHostAndPort(), new TMainQ()));
//		}
//	}
//
