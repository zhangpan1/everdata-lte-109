...
public class QuartzManager {
	...
	private static String JOB_GROUP_NAME = "group_";
	private static String TRIGGER_GROUP_NAME = "trigger_";
	 ...
	 */
	public static void addJob(String jobName, CountJob job, String time)
			throws SchedulerException, ParseException {
		Scheduler sched = sf.getScheduler();
		JobDetail jobDetail = new JobDetail(jobName, JOB_GROUP_NAME + jobName,
