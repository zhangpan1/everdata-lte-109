...
public class KafkaConsumerXdrSignallingKPI implements KafkaConsumerHandler {
	...
	public static List<KafkaConsumerXdrSignallingKPI> owner;
	...
	static {
		...
		owner = new ArrayList<KafkaConsumerXdrSignallingKPI>();
	...
	public KafkaConsumerXdrSignallingKPI(final String id) {
		this.id = id;
