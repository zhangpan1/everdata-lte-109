...
public class KafkaConsumerXdrSignalling_S1C implements KafkaConsumerHandler {
	...
	public static List<KafkaConsumerXdrSignalling_S1C> owner;
	...
	static {
		...
		owner = new ArrayList<KafkaConsumerXdrSignalling_S1C>();
	...
	public KafkaConsumerXdrSignalling_S1C(final String id) {
		this.id = id;
