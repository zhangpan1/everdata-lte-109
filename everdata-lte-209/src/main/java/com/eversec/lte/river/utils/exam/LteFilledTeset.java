...
public class LteFilledTeset {
	public static void main(String[] args) throws Exception {
		...
		cec.printRiver(host, "/home/river_filled/s11data", false, "|", ".*\\.txt$", index,
				XdrSingleSourceS10S11.class);
		cec.printRiver(host, "/home/river_filled/s1mmedata", false, "|", ".*\\.txt$", index,
				XdrSingleSourceS1MME.class);
		cec.printRiver(host, "/home/river_filled/s6adata", false, "|", ".*\\.txt$", index,
				XdrSingleSourceS6a.class);
		cec.printRiver(host, "/home/river_filled/sgsdata", false, "|", ".*\\.txt$", index,
