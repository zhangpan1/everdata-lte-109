 ...
 * 
 */
public class UuFillParam extends FillParam {
	String mmeS1apID;
	String mmeGroupID;
	String mmeCode;

	public UuFillParam(String msisdn, String imsi, String imei,
	...
	public UuFillParam(String msisdn, String imsi, String imei, long mmeS1apID,
			int mmeGroupID, short mmeCode) {
		super(msisdn, imsi, imei);
